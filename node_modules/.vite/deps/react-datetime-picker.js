...
function Mark(_a2) {
  ...
  return (0, import_jsx_runtime22.jsxs)("div", { className: "react-clock__mark react-clock__".concat(name, "-mark"), style: {
    transform: "rotate(".concat(angle, "deg)")
  ...
  } }), number ? (0, import_jsx_runtime22.jsx)("div", { className: "react-clock__mark__number", style: {
    transform: "rotate(-".concat(angle, "deg)"),
    top: "".concat(length / 2, "%")
...
var MinuteMark = (0, import_react4.memo)(function MinuteMark2(props) {
  return (0, import_jsx_runtime23.jsx)(Mark, __assign16({}, props));
});
...
function Clock(_a2) {
  ...
  function renderMinuteMarksFn() {
    ...
    for (var i = 1; i <= 60; i += 1) {
      ...
      if (!isHourMark) {
        minuteMarks.push((0, import_jsx_runtime25.jsx)(MinuteMark_default, { angle: i * 6, length: minuteMarksLength, name: "minute", width: minuteMarksWidth }, "minute_".concat(i)));
      }
    }
    return minuteMarks;
  }
  function renderHourMarksFn() {
    ...
    for (var i = 1; i <= 12; i += 1) {
      hourMarks.push((0, import_jsx_runtime25.jsx)(HourMark_default, { angle: i * 30, formatHour: formatHour2, length: hourMarksLength, locale, name: "hour", number: renderNumbers ? i : void 0, width: hourMarksWidth }, "hour_".concat(i)));
    }
    return hourMarks;
  }
  function renderFace() {
    return (0, import_jsx_runtime25.jsxs)("div", { className: "react-clock__face", children: [renderMinuteMarksFn(), renderHourMarksFn()] });
  }
  function renderHourHandFn() {
    ...
    return (0, import_jsx_runtime25.jsx)(Hand, { angle, length: hourHandLength, name: "hour", oppositeLength: hourHandOppositeLength, width: hourHandWidth });
  }
  function renderMinuteHandFn() {
    ...
    return (0, import_jsx_runtime25.jsx)(Hand, { angle, length: minuteHandLength, name: "minute", oppositeLength: minuteHandOppositeLength, width: minuteHandWidth });
  }
  function renderSecondHandFn() {
    ...
    return (0, import_jsx_runtime25.jsx)(Hand, { angle, length: secondHandLength, name: "second", oppositeLength: secondHandOppositeLength, width: secondHandWidth });
  }
  return (0, import_jsx_runtime25.jsxs)("time", { className: clsx_default("react-clock", className8), dateTime: value instanceof Date ? value.toISOString() : value || void 0, style: {
    width: size,
    height: size
...
function Fit(_a2) {
  ...
  return (0, import_jsx_runtime26.jsx)("span", { ref: function(domContainer) {
    if (!domContainer) {
      return;
    }
...
function Divider(_a2) {
  ...
  return (0, import_jsx_runtime27.jsx)("span", { className: "react-datetime-picker__inputGroup__divider", children });
}
...
function Input(_a2) {
  ...
  return (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [hasLeadingZero ? (0, import_jsx_runtime28.jsx)("span", { className: "".concat(className8, "__leadingZero"), children: "0" }) : null, (0, import_jsx_runtime28.jsx)("input", {
...
function DayInput(_a2) {
  ...
  return (0, import_jsx_runtime29.jsx)(Input, __assign19({ max: maxDay, min: minDay, name: "day" }, otherProps));
}
...
function MonthInput(_a2) {
  var maxDate = _a2.maxDate, minDate = _a2.minDate, year = _a2.year, otherProps = __rest15(_a2, ["maxDate", "minDate", "year"]);
  ...
  return (0, import_jsx_runtime30.jsx)(Input, __assign20({ max: maxMonth, min: minMonth, name: "month" }, otherProps));
}
...
function MonthSelect(_a2) {
  ...
  return (0, import_jsx_runtime31.jsxs)("select", {
    "aria-label": ariaLabel,
    autoFocus,
    ...
    required,
    value: value !== null ? value : "",
    children: [!value && (0, import_jsx_runtime31.jsx)("option", { value: "", children: placeholder }), dates.map(function(date) {
      var month = getMonthHuman(date);
      var disabled2 = month < minMonth || month > maxMonth;
      return (0, import_jsx_runtime31.jsx)("option", { disabled: disabled2, value: month, children: formatter(locale, date) }, month);
    })]
  });
}
...
function YearInput(_a2) {
  var maxDate = _a2.maxDate, minDate = _a2.minDate, _b = _a2.placeholder, placeholder = _b === void 0 ? "----" : _b, valueType = _a2.valueType, otherProps = __rest16(_a2, ["maxDate", "minDate", "placeholder", "valueType"]);
  ...
  return (0, import_jsx_runtime32.jsx)(Input, __assign21({ max: maxYear, min: minYear, name: "year", placeholder, step: yearStep }, otherProps));
}
...
function Input2(_a2) {
  ...
  var hasLeadingZero = showLeadingZeros && value && Number(value) < 10 && (value === "0" || !value.toString().startsWith("0"));
  var maxLength = max ? max.toString().length : null;
  return (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [hasLeadingZero ? (0, import_jsx_runtime33.jsx)("span", { className: "".concat(className8, "__leadingZero"), children: "0" }) : null, (0, import_jsx_runtime33.jsx)("input", {
    "aria-label": ariaLabel,
    autoComplete: "off",
    autoFocus,
    className: clsx_default("".concat(className8, "__input"), "".concat(className8, "__").concat(nameForClass || name), hasLeadingZero && "".concat(className8, "__input--hasLeadingZero")),
...
function Hour12Input(_a2) {
  var amPm = _a2.amPm, maxTime = _a2.maxTime, minTime = _a2.minTime, value = _a2.value, otherProps = __rest17(_a2, ["amPm", "maxTime", "minTime", "value"]);
  var maxHour = safeMin2(12, maxTime && function() {
    var _a3 = convert24to12(getHours(maxTime)), maxHourResult = _a3[0], maxAmPm = _a3[1];
    if (maxAmPm !== amPm) {
      return null;
    }
  ...
  var minHour = safeMax2(1, minTime && function() {
    var _a3 = convert24to12(getHours(minTime)), minHourResult = _a3[0], minAmPm = _a3[1];
    if (
  ...
  return (0, import_jsx_runtime34.jsx)(Input2, __assign22({ max: maxHour, min: minHour, name: "hour12", nameForClass: "hour", value: value12 }, otherProps));
}
...
function Hour24Input(_a2) {
  var maxTime = _a2.maxTime, minTime = _a2.minTime, otherProps = __rest18(_a2, ["maxTime", "minTime"]);
  var maxHour = safeMin2(23, maxTime && getHours(maxTime));
  var minHour = safeMax2(0, minTime && getHours(minTime));
  return (0, import_jsx_runtime35.jsx)(Input2, __assign23({ max: maxHour, min: minHour, name: "hour24", nameForClass: "hour" }, otherProps));
}
...
function MinuteInput(_a2) {
  var hour = _a2.hour, maxTime = _a2.maxTime, minTime = _a2.minTime, _b = _a2.showLeadingZeros, showLeadingZeros = _b === void 0 ? true : _b, otherProps = __rest19(_a2, ["hour", "maxTime", "minTime", "showLeadingZeros"]);
  ...
  return (0, import_jsx_runtime36.jsx)(Input2, __assign24({ max: maxMinute, min: minMinute, name: "minute", showLeadingZeros }, otherProps));
}
...
function SecondInput(_a2) {
  var hour = _a2.hour, maxTime = _a2.maxTime, minTime = _a2.minTime, minute = _a2.minute, _b = _a2.showLeadingZeros, showLeadingZeros = _b === void 0 ? true : _b, otherProps = __rest20(_a2, ["hour", "maxTime", "minTime", "minute", "showLeadingZeros"]);
  ...
  return (0, import_jsx_runtime37.jsx)(Input2, __assign25({ max: maxSecond, min: minSecond, name: "second", showLeadingZeros }, otherProps));
}
...
function AmPm(_a2) {
  ...
  return (0, import_jsx_runtime38.jsxs)("select", {
    "aria-label": ariaLabel,
    autoFocus,
    className: clsx_default("".concat(className8, "__input"), "".concat(className8, "__").concat(name)),
    "data-input": "true",
    ...
    required,
    value: value !== null ? value : "",
    children: [!value && (0, import_jsx_runtime38.jsx)("option", { value: "", children: "--" }), (0, import_jsx_runtime38.jsx)("option", { disabled: amDisabled, value: "am", children: amLabel }), (0, import_jsx_runtime38.jsx)("option", { disabled: pmDisabled, value: "pm", children: pmLabel })]
  });
}
...
function NativeInput(_a2) {
  ...
  return (0, import_jsx_runtime39.jsx)("input", { "aria-label": ariaLabel, disabled, hidden: true, max: maxDate ? nativeValueParser(maxDate) : void 0, min: minDate ? nativeValueParser(minDate) : void 0, name, onChange, onFocus: stopPropagation, required, step, style: {
    visibility: "hidden",
    position: "absolute",
    zIndex: "-999"
...
function renderCustomInputs(placeholder, elementFunctions, allowMultipleInstances) {
  ...
  return placeholder.split(pattern).reduce(function(arr, element, index) {
    ...
    (0, import_jsx_runtime40.jsx)(Divider, { children: element }, "separator_".concat(index));
    arr.push(divider);
...
function DateTimeInput(_a2) {
  ...
  function renderDay(currentMatch, index) {
    ...
    return (0, import_jsx_runtime40.jsx)(DayInput, __assign26({}, commonInputProps, {
  ...
  function renderMonth(currentMatch, index) {
    ...
    if (currentMatch.length > 2) {
      return (0, import_jsx_runtime40.jsx)(MonthSelect, __assign26({}, commonInputProps, {
    ...
    var showLeadingZerosFromFormat = currentMatch && currentMatch.length === 2;
    return (0, import_jsx_runtime40.jsx)(MonthInput, __assign26({}, commonInputProps, {
      ariaLabel: monthAriaLabel,
      // eslint-disable-next-line jsx-a11y/no-autofocus
      autoFocus: index === 0 && autoFocus,
      inputRef: monthInput,
  ...
  function renderYear(currentMatch, index) {
    return (0, import_jsx_runtime40.jsx)(YearInput, __assign26({}, commonInputProps, {
  ...
  function renderHour12(currentMatch, index) {
    ...
    return (0, import_jsx_runtime40.jsx)(Hour12Input, __assign26({}, commonInputProps, commonTimeInputProps, {
      amPm,
  ...
  function renderHour24(currentMatch, index) {
    ...
    var showLeadingZeros2 = currentMatch ? currentMatch.length === 2 : false;
    return (0, import_jsx_runtime40.jsx)(Hour24Input, __assign26({}, commonInputProps, commonTimeInputProps, {
      ariaLabel: hourAriaLabel,
      // eslint-disable-next-line jsx-a11y/no-autofocus
      autoFocus: index === 0 && autoFocus,
  ...
  function renderMinute(currentMatch, index) {
    ...
    var showLeadingZeros2 = currentMatch ? currentMatch.length === 2 : false;
    return (0, import_jsx_runtime40.jsx)(MinuteInput, __assign26({}, commonInputProps, commonTimeInputProps, {
  ...
  function renderSecond(currentMatch, index) {
    ...
    return (0, import_jsx_runtime40.jsx)(SecondInput, __assign26({}, commonInputProps, commonTimeInputProps, {
  ...
  function renderAmPm(currentMatch, index) {
    return (0, import_jsx_runtime40.jsx)(AmPm, __assign26({}, commonInputProps, commonTimeInputProps, {
  ...
  function renderNativeInput() {
    return (0, import_jsx_runtime40.jsx)(NativeInput, { ariaLabel: nativeInputAriaLabel, disabled, maxDate: maxDate || defaultMaxDate2, minDate: minDate || defaultMinDate2, name, onChange: onChangeNative, required, value, valueType }, "datetime");
  }
  return (
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions
    (0, import_jsx_runtime40.jsxs)("div", { className: className8, onClick, children: [renderNativeInput(), renderCustomInputsInternal()] })
  );
}
...
var CalendarIcon = (0, import_jsx_runtime41.jsxs)("svg", __assign27({}, iconProps, { className: "".concat(baseClassName2, "__calendar-button__icon ").concat(baseClassName2, "__button__icon"), children: [(0, import_jsx_runtime41.jsx)("rect", { fill: "none", height: "15", width: "15", x: "2", y: "2" }), (0, import_jsx_runtime41.jsx)("line", { x1: "6", x2: "6", y1: "0", y2: "4" }), (0, import_jsx_runtime41.jsx)("line", { x1: "13", x2: "13", y1: "0", y2: "4" })] }));
var ClearIcon = (0, import_jsx_runtime41.jsxs)("svg", __assign27({}, iconProps, { className: "".concat(baseClassName2, "__clear-button__icon ").concat(baseClassName2, "__button__icon"), children: [(0, import_jsx_runtime41.jsx)("line", { x1: "4", x2: "15", y1: "4", y2: "15" }), (0, import_jsx_runtime41.jsx)("line", { x1: "15", x2: "4", y1: "4", y2: "15" })] }));
function DateTimePicker(props) {
  ...
  var closeCalendar = (0, import_react10.useCallback)(function(_a3) {
    var reason = _a3.reason;
  ...
  var closeClock = (0, import_react10.useCallback)(function(_a3) {
    var reason = _a3.reason;
    if (shouldCloseWidgets) {
  ...
  var closeWidgets = (0, import_react10.useCallback)(function(_a3) {
    var reason = _a3.reason;
  ...
  function renderInputs() {
    ...
    return (0, import_jsx_runtime41.jsxs)("div", { className: "".concat(baseClassName2, "__wrapper"), children: [(0, import_jsx_runtime41.jsx)(DateTimeInput, __assign27({}, ariaLabelProps, placeholderProps, {
      // eslint-disable-next-line jsx-a11y/no-autofocus
      autoFocus,
      ...
      showLeadingZeros,
      value: valueFrom
    })), clearIcon !== null && (0, import_jsx_runtime41.jsx)("button", { "aria-label": clearAriaLabel, className: "".concat(baseClassName2, "__clear-button ").concat(baseClassName2, "__button"), disabled, onClick: clear, onFocus: stopPropagation, type: "button", children: typeof clearIcon === "function" ? (0, import_react10.createElement)(clearIcon) : clearIcon }), calendarIcon !== null && !disableCalendar && (0, import_jsx_runtime41.jsx)("button", { "aria-expanded": isCalendarOpen || false, "aria-label": calendarAriaLabel, className: "".concat(baseClassName2, "__calendar-button ").concat(baseClassName2, "__button"), disabled, onClick: toggleCalendar, onFocus: stopPropagation, type: "button", children: typeof calendarIcon === "function" ? (0, import_react10.createElement)(calendarIcon) : calendarIcon })] });
  }
  function renderCalendar() {
    ...
    var calendar = (0, import_jsx_runtime41.jsx)(esm_default2, __assign27({ locale, maxDate, minDate, onChange: function(value3) {
      return onDateChange(value3);
    }, value: value2 }, calendarProps));
    return portalContainer ? (0, import_react_dom.createPortal)((0, import_jsx_runtime41.jsx)("div", { ref: calendarWrapper, className: classNames, children: calendar }), portalContainer) : (0, import_jsx_runtime41.jsx)(esm_default4, { children: (0, import_jsx_runtime41.jsx)("div", { ref: function(ref) {
  ...
  function renderClock() {
    ...
    var clockProps = props.clockProps, _a3 = props.maxDetail, maxDetail2 = _a3 === void 0 ? "minute" : _a3, portalContainer = props.portalContainer, value2 = props.value;
    ...
    var clock = (0, import_jsx_runtime41.jsx)(esm_default3, __assign27({ locale, renderMinuteHand: maxDetailIndex > 0, renderSecondHand: maxDetailIndex > 1, value: valueFrom }, clockProps));
    return portalContainer ? (0, import_react_dom.createPortal)((0, import_jsx_runtime41.jsx)("div", { ref: clockWrapper, className: classNames, children: clock }), portalContainer) : (0, import_jsx_runtime41.jsx)(esm_default4, { children: (0, import_jsx_runtime41.jsx)("div", { ref: function(ref) {
      if (ref && !isClockOpen) {
        ref.removeAttribute("style");
      }
  ...
  return (0, import_jsx_runtime41.jsxs)("div", __assign27({ className: clsx_default(baseClassName2, "".concat(baseClassName2, "--").concat(isCalendarOpen || isClockOpen ? "open" : "closed"), "".concat(baseClassName2, "--").concat(disabled ? "disabled" : "enabled"), className8), "data-testid": dataTestid, id }, eventProps, { onFocus: onFocus3, ref: wrapper, children: [renderInputs(), renderCalendar(), renderClock()] }));
}
